package com.deliverynow.order.adapters.api;

import com.deliverynow.order.adapters.api.response.BaseResponse;
...
public class PaymentEndpoint {
    ...
    public PaymentEndpoint(PaymentController paymentController) {
